  ...
  <div class="flex-1 flex flex-col min-w-0 lg:pl-64">
    <header class="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center gap-4 sticky top-0 z-10">
      ...
      <div class="flex items-center gap-3">
        ...
        {{-- PWA Install --}}
        <button id="installBtn" title="Install App" class=" w-8 h-8 rounded-lg border border-blue-200 bg-blue-50 flex items-center justify-center text-blue-600 hover:bg-blue-100 transition-colors">
        ...
        @php $lowStock = \App\Models\Inventory::whereRaw('quantity <= (SELECT alert_quantity FROM items WHERE items.id=inventory.item_id)')->count(); @endphp
          @if($lowStock > 0)
          <a href="{{ route('notifications.index') }}" class="relative text-amber-500">
  ...
  <script>
    ...
    (function() {
      ...
      if (isDark) {
        ...
        moonI.classList.add('hidden');
        sunI.classList.remove('hidden');
      }
